// Source: https://npmcdn.com/@turf/turf@5.1.6/turf.min.js
!(function(t, e) {
    ...
    for (
      ...
      for (var p = 0, f = t[1]; f <= t[3]; ) {
        var g = null,
          d = null;
        h % 2 == 0 && p % 2 == 0
          ? ((g = o([[[l, f], [l, f + u], [l + a, f], [l, f]]], r)),
            (d = o([[[l, f + u], [l + a, f + u], [l + a, f], [l, f + u]]], r)))
          : h % 2 == 0 && p % 2 == 1
          ? ((g = o([[[l, f], [l + a, f + u], [l + a, f], [l, f]]], r)),
            (d = o([[[l, f], [l, f + u], [l + a, f + u], [l, f]]], r)))
          : p % 2 == 0 && h % 2 == 1
          ? ((g = o([[[l, f], [l, f + u], [l + a, f + u], [l, f]]], r)),
            (d = o([[[l, f], [l + a, f + u], [l + a, f], [l, f]]], r)))
          : p % 2 == 1 &&
            h % 2 == 1 &&
            ((g = o([[[l, f], [l, f + u], [l + a, f], [l, f]]], r)),
            (d = o([[[l, f + u], [l + a, f + u], [l + a, f], [l, f + u]]], r))),
  ...
  (el.prototype.getNodeCapacity = function() {
      ...
      if (3 === arguments.length) {
        ...
        for (
          ...
          if (
            ...
            (u instanceof Kh && (o = this.remove(n, u, i)))
          ) {
            s = u;
            break;
          }
    ...
    (el.prototype.createParentBoundables = function(t, e) {
      ...
      for (var i = r.iterator(); i.hasNext(); ) {
        ...
        this.lastNode(n)
          .getChildBoundables()
          .size() === this.getNodeCapacity() && n.add(this.createNode(e)),
  ...
  (Nl.prototype.isDeletable = function(t, e, n, r) {
    ...
    return (
      ...
      (!!this.isShallow(i, o, s, r) && this.isShallowSampled(i, o, t, n, r))
    );
  }),
  ...
  (ql.prototype.area = function() {
    ...
    (ql.isAcute = function(t, e, n) {
      return (
        !!Ll.isAcute(t, e, n) &&
        (!!Ll.isAcute(e, n, t) && !!Ll.isAcute(n, t, e))
      );
    }),
  ...
  var ep = (function(t) {
      ...
      return (
        ...
        (e.prototype.isCollapsed = function() {
          return (
            !!this._label.isArea() &&
            (3 === this.pts.length && !!this.pts[0].equals(this.pts[2]))
          );
        }),
        (e.prototype.isClosed = function() {
        ...
        !!this._li.isProper() ||
          ...
          !!this._li.isProper() ||
            ...
            !!this._li.isProper() ||
              ...
              !!this._li.isProper() ||
                (!(!n || !r) ||
                  (!!t.equals(this._pt) || !!e.equals(this._pt))))))
      );
    }),
  ...
  var Sg = function() {
    var t = (function(t) {
        function e() {
          ...
          return c(
            null == h
              ? [[s[0] - e, s[1] - e], [s[0] + e, s[1] + e]]
              : t === Eo
              ? [[Math.max(s[0] - e, h), n], [Math.min(s[0] + e, r), i]]
              : [[h, Math.max(s[1] - e, n)], [r, Math.min(s[1] + e, i)]]
          );
        }
        var n,
          r,
