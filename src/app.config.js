...
appConfig.skins = [
...

  {
    ...
    class: 'btn btn-xs btn-block txt-color-white margin-top-5',
    style:
      'background: #bbc0cf; border: 1px solid #59779E; color: #17273D !important;',
    label: 'PixelSmash'
  },

  {
    ...
    class: 'btn btn-xs btn-block txt-color-white margin-top-5',
    style:
      'background: rgba(153, 179, 204, 0.2); border: 1px solid rgba(121, 161, 221, 0.8); color: #17273D !important;',
    label: 'Glass'
  },

  {
    ...
    class: 'btn btn-xs btn-block txt-color-white margin-top-5',
    style:
      'background: #2196F3; border: 1px solid rgba(121, 161, 221, 0.8); color: #FFF !important;',
    beta: true,
...
if (appConfig.voice_command) {
  appConfig.commands = {
    ...
    'hide navigation': function() {
      if (
        $(':root').hasClass('container') &&
        !$(':root').hasClass('menu-on-top')
      ) {
...
appConfig.defaultCacheExpire = 60000; // in milliseconds
...
appConfig.CORAL_ATLAS_APP_ID = MERMAID_CONFIG.CORAL_ATLAS_APP_ID || '';
