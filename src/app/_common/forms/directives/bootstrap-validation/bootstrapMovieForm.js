...
angular.module('SmartAdmin.Forms').directive('bootstrapMovieForm', function() {
  return {
    ...
    replace: true,
    templateUrl:
      'app/_common/forms/directives/bootstrap-validation/bootstrap-movie-form.tpl.html',
          ...
          director: {
            ...
            validators: {
              ...
              stringLength: {
                max: 80,
                message:
                  'The director name must be less than 80 characters long'
              }
            }
          },
          writer: {
          ...
          producer: {
            ...
            validators: {
              ...
              stringLength: {
                max: 80,
                message:
                  'The producer name must be less than 80 characters long'
              }
            }
          },
          website: {
