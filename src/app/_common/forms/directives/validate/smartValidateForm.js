...
angular
  ...
  .directive('smartValidateForm', function(formsCommon) {
    return {
      restrict: 'A',
        ...
        form
          ...
          .each(function() {
            ...
            if ($input.data('maxlength') != undefined) {
              validateOptions.rules[fieldName].maxlength = $input.data(
                'maxlength'
              );
            }

            if ($input.data('minlength') != undefined) {
              validateOptions.rules[fieldName].minlength = $input.data(
                'minlength'
              );
            }
