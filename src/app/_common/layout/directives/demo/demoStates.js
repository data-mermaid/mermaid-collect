...
angular
  ...
  .directive('demoStates', function($rootScope) {
    return {
      restrict: 'EA',
      replace: true,
          ...
          $.SmartMessageBox(
            {
              ...
              content:
                'Would you like to RESET all your saved widgets and clear LocalStorage?1',
              buttons: '[No][Yes]'
            },
