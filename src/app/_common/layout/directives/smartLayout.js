...
angular
  ...
  .directive('smartLayout', function(
    $rootScope,
    $timeout,
    $interval,
    $q,
    ...
    (function cacheElements() {
      ...
      $footer = $('.page-footer');
      if (
        _.every([$navigation, $menu, $ribbon, $footer], function($it) {
    ...
    return {
      ...
      compile: function(tElement, tAttributes) {
        ...
        function resizeListener() {
          ...
          var menuHeight =
            $body.hasClass('menu-on-top') && $menu.is(':visible')
              ? $menu.height()
              : 0;
          var menuWidth =
            !$body.hasClass('menu-on-top') && $menu.is(':visible')
              ? $menu.width() + $menu.offset().left
              : 0;
        ...
        function loop() {
          ...
          if ($window.width() < 979) $body.removeClass('minified');
