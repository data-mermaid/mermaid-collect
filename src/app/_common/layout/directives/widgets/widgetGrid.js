...
angular
  ...
  .directive('widgetGrid', function(
    ...
    var setupWidgets = function(element, widgetIds) {
      if (!setupWaiting) {
        if (
          _.intersection(widgetIds, dispatchedWidgetIds).length !=
          widgetIds.length
        ) {
          ...
          element.data('jarvisWidgets') &&
            element.data('jarvisWidgets').destroy();
    ...
    return {
      ...
      compile: function(element) {
        ...
        jarvisWidgetAddedOff = $rootScope.$on('jarvisWidgetAdded', function(
          event,
          widget
        ) {
